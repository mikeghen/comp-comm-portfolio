...
contract CompoundIntegrationBase is Test {
    ...
    address constant UNISWAP_V3_ROUTER = 0xE592427A0AEce92De3Edee1F18E0157C05861564; // canonical v3 router
    // TODO: Add comet rewards claiming
    address constant COMET_REWARDS_DUMMY = 0x0000000000000000000000000000000000000001;

    VaultManager vault;

    uint256 constant SUPPLY_AMOUNT = 1_000e6;
    ...
    function setUp() public virtual {
        ...
        vault = new VaultManager(USDC, WETH, address(0), UNISWAP_V3_ROUTER, COMET_REWARDS_DUMMY, address(this));

...
contract Mint is ManagementTokenTest {
    ...
    function testFuzz_RevertIf_CallerDoesNotHaveMinterRole(address _caller, address _to, uint256 _amount) public {
        ...
        // ---- Arrange & Assert
        vm.expectRevert(
            abi.encodeWithSelector(IAccessControl.AccessControlUnauthorizedAccount.selector, _caller, MINTER_ROLE)
        );
...
contract BurnFrom is ManagementTokenTest {
    ...
    function testFuzz_RevertIf_CallerDoesNotHaveBurnerRole(address _caller, address _account, uint256 _amount) public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IAccessControl.AccessControlUnauthorizedAccount.selector, _caller, BURNER_ROLE)
        );
    ...
    function testFuzz_RevertIf_InsufficientAllowance(address _account, uint256 _amount, uint256 _approval) public {
        _assumeSafeAddress(_account);
        _amount = _boundMintAmount(_amount);
...
contract Pause is ManagementTokenTest {
    ...
    function testFuzz_RevertIf_CallerDoesNotHavePauserRole(address _caller) public {
        ...
        // ---- Arrange & Assert
        vm.expectRevert(
            abi.encodeWithSelector(IAccessControl.AccessControlUnauthorizedAccount.selector, _caller, PAUSER_ROLE)
        );
...
contract Update is ManagementTokenTest {
    ...
    function testFuzz_AllowsApprovalWhenPaused(address _owner, address _spender, uint256 _amount) public {
